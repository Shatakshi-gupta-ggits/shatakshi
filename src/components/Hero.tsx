...
const heroContent = {
  freelancer: {
    ...
    highlight: "Gen AI Developer",
    subtitle: "Full-Stack · Data · LLMs · Automation",
    description: "I build AI-powered products, fine-tune LLMs, craft data pipelines, and ship full-stack apps. Open for roles — AI Developer, Data Analyst, Python/Java Dev, MERN Engineer & more.",
    primaryCTA: "Hire Me",
    primaryLink: "#contact",
    ...
    accentColor: "pulse",
    terminalTexts: [
      "python3 train_llm.py --model=llama3 --epochs=50",
      "langchain run agent --tools=search,code",
      "docker compose up ai-pipeline",
      "curl -X POST /v1/chat/completions",
      "git push origin main && vercel deploy",
      "pandas.read_csv('data.csv').describe()",
    ],
  },
  tutor: {
    badge: "01",
    badgeText: "Learn",
    title: "Hi, I'm Shatakshi",
    highlight: "AI & Code Mentor",
    subtitle: "LLMs · DSA · Full-Stack · Interview Prep",
    description: "Helping aspiring developers master Gen AI, crack interviews, and build successful careers in tech. From LangChain to React — I've got you covered.",
    ...
    terminalTexts: [
      ...
      "python3 teach.py --topic='prompt-engineering'",
      "curl -X POST /api/book-session",
      "langchain run tutorial --student=you",
    ],
  },
};
